<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="name" label="发件人" width="80"> </el-table-column>
...
export default {
  ...
  created: function () {
    ...
    this.$http.get("/mail/recvlist").then(async (res) => {
      let r = res.data;
      for (let i = r.length - 1; i > -1; i--) {
        let fromid = r[i].fromid;
        let p = await getNameById(fromid);
