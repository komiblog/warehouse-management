...
export default {
    ...
    methods: {
        upload() {
            ...
            // });
            // fd.append("p_name", this.form.p_name);
            // fd.append("p_type", this.form.p_type);
            // fd.append("p_depiction", this.form.p_depiction);
            // fd.append("p_price", this.form.p_price);
            // fd.append("p_count", this.form.p_count);
